...
if(isset($_SESSION['id']) && isset($_GET['per']) && ($_GET['per']=="jobseeker")){header("location:jobs.php?per=jobseeker");}
if(isset($_SESSION['id']) && isset($_GET['per']) && ($_GET['per']=="employer")){header("location:employersection.php?per=employer");}
